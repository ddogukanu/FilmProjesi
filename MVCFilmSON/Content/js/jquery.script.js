$(document).ready(function () {
    //lilerin herbiri için
    $(".pagination li").each(function () {
        $(this).addClass("pager-item");
        $(this).find("a").addClass("button").addClass("button_small");
    });
    $("#form_yil").change(function () {
        var secilen = $(this).val();
        //window.location.href
        var adres = window.location.href;
        adres = adres.substring(0, adres.indexOf("?"));
        window.location.href = adres + "?y=" + secilen;
    });


    $("#form_titles").change(function () {
        var secilen = $(this).val();
        //window.location.href
        var adres = window.location.href;
        adres = adres.substring(0, adres.indexOf("?"));
        window.location.href = adres + "?sirala="+secilen;
    });
});
